...
plaintexts = b"""I am the very model of a modern Major-General
...
if accuracy < .90:
   raise Exception('Many time pad cracker accuracy has reduced below 90% accuracy. Test failed.')
