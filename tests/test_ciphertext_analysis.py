...
plaintext = b'I am the very model of a modern major-general, I\'ve information vegetable, animal and mineral, I know the kings of England and I quote the fights historical, from Marathon to Waterloo in order categoricalAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA'

plaintext2 = b'I am the very model of a modern major-general, I\'m covered in bees and I have information vegetable, animal and mineral, I know the kings of England and I quote the fights historical, from Marathon to Waterloo in order categoricalAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA'

RSA_pubkey_critically_small_n = b"""-----BEGIN PUBLIC KEY-----
MDswDQYJKoZIhvcNAQEBBQADKgAwJwIgM+SdTJtjCuCzjqr34+02DsEEp8TOuDOq
2nznVqc7g1ECAwEAAQ==
-----END PUBLIC KEY-----
"""

RSA_pubkey_very_small_n = b"""
-----BEGIN PUBLIC KEY-----
...
mb_xor_ciphertexts = [ca.sxor(plaintext,b"\xfa\x4e\x77\x01\x43"*len(plaintext))]
mb_xor_ciphertexts.append(ca.sxor(plaintext2,b"\xfa\x4e\x77\x01\x43"*len(plaintext2)))
...
hex_results = ca.analyze_ciphertext([hexlify(ct) for ct in ecb_ciphertexts])
...
base64_results = ca.analyze_ciphertext([b64encode(ct) for ct in ecb_ciphertexts])
